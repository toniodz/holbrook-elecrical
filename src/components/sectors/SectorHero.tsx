      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-[90vw]">
          <h1 className="text-scale-8xl font-bold leading-[1.1] tracking-tight mb-scale-lg">
            Sector-Specific Electrical Expertise
          </h1>
          
          <p className="text-scale-2xl text-blue-200 mb-scale-xl max-w-3xl">
            Specialized electrical solutions tailored to the unique requirements of your industry, backed by years of sector-specific experience.
          </p>

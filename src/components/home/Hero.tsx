    ...
    <div className="relative min-h-[80vh] flex items-center bg-blue-900 text-white overflow-hidden py-24 md:py-32">
      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-[90vw]">
          <h1 className="text-scale-8xl font-bold leading-[1.1] tracking-tight mb-scale-xl">
            Industrial & Commercial Electrical Contractors
          </h1>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/contact"
              className="text-scale-md bg-blue-600 text-white px-8 py-3 rounded-md text-center hover:bg-blue-700 transition-colors"
            >
